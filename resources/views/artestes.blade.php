        ...
        <section class="events-hero">
            <div class="events-bar">
                <div class="events-title-wrap">
                    <h1 class="page-title">artests</h1>
                    <p class="page-subtitle">artests.</p>
                </div>
            ...
            <div class="eventsGrid">
                ...
                <div class="work">
                    <a href="/artists/Kaustav-Banerjee">
                        <div class="work-img">
                            <img class="personalImg" loading="lazy" src="https://i.sstatic.net/XDaUk.jpg?s=256" alt="Artist Avatar">
                        </div>
                        <div class="work-info">
